...
> [English](COMMUNITY_FORENSICS_V3_ERROR_ANALYSIS_NOTE.md) | **中文**
...
完整的 Clean 与 transformed 汇总见 [`COMMUNITY_FORENSICS_V3_ROBUSTNESS_EVALUATION_SUMMARY_Chinese.md`](COMMUNITY_FORENSICS_V3_ROBUSTNESS_EVALUATION_SUMMARY_Chinese.md)。
